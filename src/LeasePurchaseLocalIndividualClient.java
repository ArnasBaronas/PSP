...
public class LeasePurchaseLocalIndividualClient extends LeasePurchase {

    public LeasePurchaseLocalIndividualClient(int number, Product product, Date date, String client, int duration, int clientCreditScore){
